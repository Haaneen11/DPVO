...
class DPVO:
    ...
    def reproject(self, indicies=None):
        ...
        # Ensure indicies is provided, or default to self.pg.ii, self.pg.jj, self.pg.kk
    ...
    def __call__(self, tstamp, image, intrinsics):
        """ Track new frame and output results in real-time """
        ...
        current_pose = self.pg.poses_[self.n - 1] if self.n > 0 else None
        return current_pose, tstamp
